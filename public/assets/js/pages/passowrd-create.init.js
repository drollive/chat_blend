...
var password = document.getElementById("password-input")
  , confirm_password = document.getElementById("confirm-password-input"), invalid_password = document.getElementById("invalid-password");

function validatePassword() {
    password.value != confirm_password.value ? (confirm_password.classList.remove("valid"),confirm_password.classList.add("invalid"), invalid_password.classList.add("invalid")) : (confirm_password.classList.remove("invalid"),confirm_password.classList.add("valid"), invalid_password.classList.remove("invalid"))
}
