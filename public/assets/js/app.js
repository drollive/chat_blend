		...
		document.getElementById("header-lang-img") &&
			("en" == e
				? (document.getElementById(
						"header-lang-img"
				  ).src = `${baseURL}public/assets/images/flags/us.svg`)
				: "sp" == e
				? (document.getElementById(
						"header-lang-img"
				  ).src = `${baseURL}public/assets/images/flags/spain.svg`)
				: "gr" == e
				? (document.getElementById(
						"header-lang-img"
				  ).src = `${baseURL}public/assets/images/flags/germany.svg`)
				: "it" == e
				? (document.getElementById(
						"header-lang-img"
				  ).src = `${baseURL}public/assets/images/flags/italy.svg`)
				: "ru" == e
				? (document.getElementById(
						"header-lang-img"
				  ).src = `${baseURL}public/assets/images/flags/russia.svg`)
				: "ch" == e
				? (document.getElementById(
						"header-lang-img"
				  ).src = `${baseURL}public/assets/images/flags/china.svg`)
				: "fr" == e &&
				  (document.getElementById(
						"header-lang-img"
				  ).src = `${baseURL}public/assets/images/flags/french.svg`),
			localStorage.setItem("language", e),
			(b = localStorage.getItem("language")),
			(function () {
				null == b && y(g);
				var e = new XMLHttpRequest();
				e.open("GET", `${baseURL}public/assets/lang/` + b + ".json"),
