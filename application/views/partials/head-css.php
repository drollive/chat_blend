...
<!-- landing Css-->
<link href="<?php echo base_url('public/assets') ?>/css/landing.css" rel="stylesheet" type="text/css" />
<!-- Auth Css-->
<link href="<?php echo base_url('public/assets') ?>/css/auth.css" rel="stylesheet" type="text/css" />
</head>