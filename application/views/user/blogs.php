                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="row gallery-wrapper">
                                                    ...
                                                    <div class="gallery-box card">
                                                        <div class="gallery-container">
                                                            <a class="image-popup" href="<?php echo base_url('public/assets') ?>/images/small/img-1.jpg" title="">
                                                                <img class="gallery-img img-fluid mx-auto" src="<?php echo base_url('public/assets') ?>/images/small/img-1.jpg" alt="" />
                                                    ...
                                                    <div class="gallery-box card">
                                                        <div class="gallery-container">
                                                            <a class="image-popup" href="<?php echo base_url('public/assets') ?>/images/small/img-2.jpg" title="">
                                                                <img class="gallery-img img-fluid mx-auto" src="<?php echo base_url('public/assets') ?>/images/small/img-2.jpg" alt="" />
                                                                <div class="gallery-overlay">
                                                    ...
                                                    <div class="gallery-box card">
                                                        <div class="gallery-container">
                                                            <a class="image-popup" href="<?php echo base_url('public/assets') ?>/images/small/img-3.jpg" title="">
                                                                <img class="gallery-img img-fluid mx-auto" src="<?php echo base_url('public/assets') ?>/images/small/img-3.jpg" alt="" />
                                                                <div class="gallery-overlay">
                                                    ...
                                                    <div class="gallery-box card">
                                                        <div class="gallery-container">
                                                            <a class="image-popup" href="<?php echo base_url('public/assets') ?>/images/small/img-4.jpg" title="">
                                                                <img class="gallery-img img-fluid mx-auto" src="<?php echo base_url('public/assets') ?>/images/small/img-4.jpg" alt="" />
                                                                <div class="gallery-overlay">
                                                    ...
                                                    <div class="gallery-box card">
                                                        <div class="gallery-container">
                                                            <a class="image-popup" href="<?php echo base_url('public/assets') ?>/images/small/img-5.jpgg" title="">
                                                                <img class="gallery-img img-fluid mx-auto" src="<?php echo base_url('public/assets') ?>/images/small/img-5.jpg" alt="" />
                                                                <div class="gallery-overlay">
                                                ...
                                                <div class="element-item col-xxl-3 col-xl-4 col-sm-6 photography" data-category="photography">
                                                    <div class="gallery-box card">
                                                        <div class="gallery-container">
                                                            <a class="image-popup" href="<?php echo base_url('public/assets') ?>/images/small/img-6.jpg" title="">
                                                                <img class="gallery-img img-fluid mx-auto" src="<?php echo base_url('public/assets') ?>/images/small/img-6.jpg" alt="" />
                                                                <div class="gallery-overlay">
                                                    ...
                                                    <div class="gallery-box card">
                                                        <div class="gallery-container">
                                                            <a class="image-popup" href="<?php echo base_url('public/assets') ?>/images/small/img-7.jpg" title="">
                                                                <img class="gallery-img img-fluid mx-auto" src="<?php echo base_url('public/assets') ?>/images/small/img-7.jpg" alt="" />
                                                                <div class="gallery-overlay">
                                                    ...
                                                    <div class="gallery-box card">
                                                        <div class="gallery-container">
                                                            <a class="image-popup" href="<?php echo base_url('public/assets') ?>/images/small/img-8.jpg" title="">
                                                                <img class="gallery-img img-fluid mx-auto" src="<?php echo base_url('public/assets') ?>/images/small/img-8.jpg" alt="" />
                                                                <div class="gallery-overlay">
                                                                    <h5 class="overlay-caption">Glasses and laptop from above</h5>
                                                                </div>
                                                            </a>
                                                    ...
                                                    <div class="gallery-box card">
                                                        <div class="gallery-container">
                                                            <a class="image-popup" href="<?php echo base_url('public/assets') ?>/images/small/img-9.jpg" title="">
                                                                <img class="gallery-img img-fluid mx-auto" src="<?php echo base_url('public/assets') ?>/images/small/img-9.jpg" alt="" />
                                                                <div class="gallery-overlay">
                                                    ...
                                                    <div class="gallery-box card">
                                                        <div class="gallery-container">
                                                            <a class="image-popup" href="<?php echo base_url('public/assets') ?>/images/small/img-10.jpg" title="">
                                                                <img class="gallery-img img-fluid mx-auto" src="<?php echo base_url('public/assets') ?>/images/small/img-10.jpg" alt="" />
                                                                <div class="gallery-overlay">
                                                    ...
                                                    <div class="gallery-box card">
                                                        <div class="gallery-container">
                                                            <a class="image-popup" href="<?php echo base_url('public/assets') ?>/images/small/img-11.jpg" title="">
                                                                <img class="gallery-img img-fluid mx-auto" src="<?php echo base_url('public/assets') ?>/images/small/img-11.jpg" alt="" />
                                                                <div class="gallery-overlay">
                                                    ...
                                                    <div class="gallery-box card">
                                                        <div class="gallery-container">
                                                            <a class="image-popup" href="<?php echo base_url('public/assets') ?>/images/small/img-12.jpg" title="">
                                                                <img class="gallery-img img-fluid mx-auto" src="<?php echo base_url('public/assets') ?>/images/small/img-12.jpg" alt="" />
                                                                <div class="gallery-overlay">
