    ...
    <div class="offcanvas offcanvas-end border-0" tabindex="-1" id="userProfileCanvasExample">
        ...
        <div class="offcanvas-body profile-offcanvas p-0">
            <div class="team-cover">
                <img src="<?php echo base_url('public/assets') ?>/images/people/Roy.jpg" alt="" class="img-fluid" />
            </div>
            ...
            <div class="p-3 text-center">
                <img src="<?php echo base_url('public/assets') ?>/images/people/Roy.jpg" alt="" class="avatar-lg img-thumbnail rounded-circle mx-auto">
                <div class="mt-3">
