                ...
                <div class="container-fluid mt-4">
                    <div class="profile-foreground position-relative mx-n4 mt-n4">
                        <div class="profile-wid-bg">
                            <img src="<?php echo base_url('public/assets') ?>/images/flag/Filipino.png" alt="" class="profile-wid-img" />
                        </div>
                    </div>
                    <div class="pt-4 mb-4 mb-lg-3 pb-lg-4">
                        <div class="row g-4">
                            <div class="col-auto">
                                <div class="avatar-lg">
                                    <img src="<?php echo base_url('public/assets') ?>/images/people/Filwayne.jpg" alt="user-img" class="img-thumbnail rounded-circle" />
                                </div>
                            </div>
                            <!--end col-->
                            <div class="col">
                                <div class="p-2">
                                    <h3 class="text-white mb-1">Filwayne Kean De Lara</h3>
                                    <p class="text-white-75">Filipino</p>
                                                            ...
                                                            <table class="table table-borderless mb-0">
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-muted">Filwayne Kean De Lara</td>
                                                                    </tr>
                                                                    <tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-muted">dfilwayne@gmail.com</td>
                                                                    </tr>
                                                                    <tr>
